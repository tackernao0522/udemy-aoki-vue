...
## 70 サンプルを読む テーブル CRUD

#### v-data-table CRUD サンプル

CRUD はデータ処理の基本<br>
create/read/update/delete の頭文字<br>

`v-data-table / v-toolbar / v-divider / v-spacer / v-dialog / v-btn / v-card / v-row / v-col / v-text-field / v-icon` <br>

#### Data tables

- 参考: https://vuetifyjs.com/ja/components/data-tables/ <br>

* `section05/table-sample/index.html`ファイルを作成<br>
